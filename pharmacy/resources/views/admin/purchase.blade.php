		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<a href="#" @click="addData()" class="btn btn-sm btn-primary pull-right">Create New Purchase</a>
				</div>
				<div class="card-body">
...
<script type="text/javascript">
	...
	{data: 'suppliers.name', class: 'text-center', orderable: true},
	{data: 'purchases_details.qty', class: 'text-center', orderable: true},
