		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<a href="#" @click="addData()" class="btn btn-sm btn-primary pull-right">Create New Item</a>
				</div>
				<div class="card-body">
			...
			<div class="modal-content">
				<form method="POST" :action="actionUrl" autocomplete="off" @submit="submitForm($event, data.id)">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>Qty</label>
							<input type="number" name="qty" class="form-control" placeholder="Enter Qty" :value="data.qty">		        		
						</div>		        
					</div>
...
<script type="text/javascript">
	...
	{data: 'price', render: $.fn.dataTable.render.number( '.', ',', 0, 'Rp. ' ), class: 'text-center', orderable: false},
